  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <label className="block text-sm font-medium text-zinc-400 mb-2">
        ...
        <select value={formData.specificType} onChange={(e)=> setFormData((prev)=>({...prev,specificType: e.target.value}))} className="w-full rounded-xl bg-zinc-900/50 border border-zinc-800 px-4 py-3.5
